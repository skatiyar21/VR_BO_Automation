...
public class PrizeDrawPageObj extends SuiteBase {
	...
	public static WebElement add_btn() throws Exception {
		try {
			element = fwait.until(ExpectedConditions
					.visibilityOfElementLocated(By.xpath("//button[contains(text(),'ADD PRIZE DRAW')]")));
		} catch (Exception e) {
	...
	public static WebElement title_txt() throws Exception {
		try {
			element = fwait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//*[@name='Competition_title']")));
		} catch (Exception e) {
			System.out.println(e);
		}
		return element;
	...
	public static WebElement tileLoc_drp() throws Exception {
		try {
			element = fwait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//*[@name='Competition_tileLocation']")));
		} catch (Exception e) {
			System.out.println(e);
		}
		return element;
	...
	public static WebElement description_txt() throws Exception {
		try {
			element = fwait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//*[@name='Competition_description']")));
		} catch (Exception e) {
			System.out.println(e);
		}
		return element;
	...
	public static WebElement subtitle_txt() throws Exception {
		try {
			element = fwait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//*[@name='Competition_subTitle']")));
		} catch (Exception e) {
			System.out.println(e);
		}
		return element;
